...
public class WarehouseManager {
	...
	public static void main(String[] args) throws IOException {
		...
		for (int i = 0; i < susiArray.length; i++) {
			System.out.println("あいさつパターン" + (i + 1) + "...「" + susiArray[i] + "」\n");
		}
		...
		//入力処理および入力値の代入処理
		String sentakustr = br.readLine();
		int sentaku = Integer.parseInt(sentakustr) - 1;
		System.out.print("\nあいさつを吹き込んでください＞");
		String aisatu = br.readLine();
		susiArray[sentaku] = aisatu;
